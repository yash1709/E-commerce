                        ...
                        <div className='col-4'>
                            ...
                            <div>
                                <address className='text-white fs-6'>
                                    Hno: 01 Near Kranti Chowk, <br /> Chh. SambhajiNagar, Maharashtra <br />
                                    Pincode: 431001
                                </address>
                                <a href='tel:+91 9011080585' className='mt-3 d-block mb-1 text-white'>
                                    +91 9011080585
                                </a>
                                <a href="mailto:khushalbaheti1709@gmail.com" className='mt-2 d-block mb-0 text-white'>
                    ...
                    <div className='row'>
                        <div className='col-12'>
                            <p className='text-center mb-0 text-white'>
                                &copy; {new Date().getFullYear()}; Powered by getBetter1
                            </p>
                        </div>
                    </div>
                </div>
